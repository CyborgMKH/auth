        ...
        <div class="sub-container">
            ...
            <form action="registration.php" method="post">
                <div class="form-group">
                    <input type="text" class="form-control" name="username" placeholder="Username" value="<?php echo $_SESSION['old_data']['username'] ?? '' ?>">
                ...
                <div class="form-group">
                    <input type="email" class="form-control" name="email" placeholder="Email" value="<?php echo $_SESSION['old_data']['email'] ?? '' ?>">
                ...
                <div class="form-group">
                    <input type="password" class="form-control" name="password" placeholder="Password" oninput="checkPasswordStrength(this.value,'password')" value="<?php echo $_SESSION['old_data']['password'] ?? '' ?>" id="Showpassword">
                ...
                <div class="form-group">
                    <input type="password" class="form-control" name="confirm_password" placeholder="Confirm Password" oninput="checkPasswordStrength(this.value,'confirm_password')" value="<?php echo $_SESSION['old_data']['confirm_password'] ?? '' ?>" id="Showpassword2">
